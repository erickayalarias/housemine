...
export const NavBar = () => {
  ...
  const navigate = useNavigate()
    ...
    const handleCloseNavMenu = (event: React.MouseEvent<HTMLElement>) => {
      ...
      if (event.currentTarget.innerText === "Dashboard") { 
        navigate("/dashboard")
      }
        setAnchorElNav(null);
    };
    ...
    const handleClicksee = (event: React.MouseEvent<HTMLElement>) => {
    ...
    return (
        <AppBar position="static" sx={{ bgcolor: "text.secondary", mb: 5 }}>
